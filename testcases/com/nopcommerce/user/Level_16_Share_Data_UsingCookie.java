...
public class Level_16_Share_Data_UsingCookie extends BaseTest {
	...
	public void beforeClass(String browserName, String url) {
		...
		loginPage.refeshPage(driver);
		log.info("Pre-condition - Step 3: Enter to password textbox with value is" + password);
